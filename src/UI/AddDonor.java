...
public class AddDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ID");
        body.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 120, 40));

        txtId.setEditable(false);
        txtId.setBackground(new java.awt.Color(255, 51, 51));
        txtId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtId.setForeground(new java.awt.Color(255, 255, 255));
        body.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 460, 40));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Full Name");
        body.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 120, 40));
        ...
        body.add(txtFullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 460, 40));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Age");
        body.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 120, 40));
        ...
        body.add(txtAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 90, 40));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Phone");
        body.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 120, 40));
        ...
        body.add(txtPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 300, 460, 40));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("City");
        body.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 120, 40));
        ...
        body.add(txtPhoneWarning, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 300, 120, 40));
        ...
        body.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 450, 140, 50));
        ...
        cbCity.setSelectedIndex(-1);
        body.add(cbCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 380, 460, 40));
        ...
        cbBloodGroup.setSelectedIndex(-1);
        body.add(cbBloodGroup, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 60, 320, 40));
        ...
        body.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 450, 140, 50));
        ...
        body.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 450, 140, 50));
        ...
        rbMale.setText("MALE");
        Gender.add(rbMale, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 5, 90, 30));

        body.add(Gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 300, 40));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Blood Group");
        body.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 60, 120, 40));

        txtAgeWarning.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        body.add(txtAgeWarning, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 460, 30));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(validInput())
        {
            ...
            if(txtPhone.getText().length()==11 && AGE>=18)
            {
                ...
                donor.Insert(id,name,age,gender,phone,city,bloodGroup);
                JOptionPane.showMessageDialog(this, "Donor Added Successfuly!");
                clear();                
            }
